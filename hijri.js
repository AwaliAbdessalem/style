...
var d = tod.getDate();
var dow = tod.getDay();
var cgdate = "اليوم " + weekday[dow] + " " + d + " " + monthname[m] + " " + y;

if (document.all) document.all.gresults.innerHTML = cgdate;
...
function getthedate() {
  ...
  s = checkTime(s);
  var cdate =
    "<small><font color='3F6F97' face='Cairo'>" +
    h +
    ":" +
    m +
    ":" +
